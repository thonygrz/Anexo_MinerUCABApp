...
import ProyectosConsultarFaseMaquinariaSelect from './ProyectosConsultarFaseMaquinariaSelect'
import { Button } from 'react-bootstrap'
import { history } from '../routers/AppRouter'

class ProyectosConsultarFaseMaquinaria extends React.Component {
    botonAtras = () => {
        history.goBack()
    }
    state = {
                    ...
                    <div className='etapas-proyecto'>
                        <div className='etapas-lista-proyecto'>
                            {this.state.maquinarias.map((maquinaria, index) => {
                                return <ProyectosConsultarFaseMaquinariaSelect key={index} nombre={maquinaria.nombre} />
                            })}
                        </div>
                    </div>
...
export default ProyectosConsultarFaseMaquinaria